                    ...
                    <form class="form-horizontal form-label-left" id="formNambahDokter" action="{{ url('dokter/simpan') }}" method="POST" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="nama_dokter" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="nama_dokter" placeholder="Nama Lengkap ex: Aris Hasan" required="required" type="text">
                        </div>
                      </div>
                      <div class="item form-group">
                          ...
                          <p>
                            <form class="form-horizontal form-label-left" id="formEditDokter" action="{{ url('dokter/edit') }}" method="POST" novalidate>
                              ...
                              <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input id="edit_nama_dokter" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="edit_nama_dokter" placeholder="Nama Lengkap ex: Aris Hasan" required="required" type="text">
                                </div>
                              </div>
                              <div class="item form-group">
